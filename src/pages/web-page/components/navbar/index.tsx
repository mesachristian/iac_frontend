                ...
                {NAV_ITEMS_LEFT.map((item, idx) => {
                  return (
                    <Link to={item.url} key={idx}>
                      <li>
                        <button className={"block py-3 px-5 tracking-[.2px] bg-transparent font-semibold text-[15px] border-none outline-none " + style.leftItemsColor}>
              ...
              <ul className="flex items-center list-none m-0 p-0">
                {NAV_ITEMS_RIGHT.map((item, idx) => {
                  return (
                    <li key={idx}>
                      <button
                        className={"block py-3 px-5 rounded-3xl font-semibold text-[13px] outline-none my-0 mx-3 " + style.btnBgColor + " " + style.btnTextColor}
                        style={{
                          border:
