...
const HomeBackground = () => {
    ...
    useEffect( () => {
        ...
        window.addEventListener('resize', (e) => {resizeCanvas(canvas as HTMLCanvasElement)}, false);

        resizeCanvas(canvas as HTMLCanvasElement);
    });
    ...
    return (
      <canvas id='home-background' className="absolute block top-0 left-0 z-0"></canvas>
    );
}
